...
public class ClientOrderAdapter extends ArrayAdapter<Order> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView orderChefName = listViewItem.findViewById(R.id.orderChefName);
        TextView orderQuantity = listViewItem.findViewById(R.id.orderQuantity);
        TextView orderDeliveryTime = listViewItem.findViewById(R.id.orderDeliveryTime);
        TextView orderStatus = listViewItem.findViewById(R.id.orderStatus);
